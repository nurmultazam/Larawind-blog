...
<div class="md:fixed md:w-full md:top-0 md:z-20 flex flex-row flex-wrap items-center bg-white p-6 border-b border-gray-300">
  ...
  <div class="flex-none w-56 flex flex-row items-center">
    <img src="#" class="w-10 flex-none">
    <strong class="capitalize ml-1 flex-1">WPU Blog</strong>
      ...
      <div class="dropdown relative md:static">
        ...
        <div class="text-gray-500 menu hidden md:mt-10 md:w-full rounded bg-white shadow-md absolute z-20 right-0 w-40 mt-5 py-2 animated faster">
          ...
          <form action="/logout" method="POST">
            @csrf
            <button type="submit" class="px-4 py-2 w-full text-left block capitalize font-medium text-sm tracking-wide bg-white hover:bg-gray-200 hover:text-gray-900 transition-all duration-300 ease-in-out"><i class="fa-solid fa-right-from-bracket text-xs mr-1"></i>  Logout</button>
          </form>
          <!-- end item -->
